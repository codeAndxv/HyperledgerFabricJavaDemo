...
public class DeployInstantiateChaincode {
	...
	public static void main(String[] args) {
		try {
			...
			org1Admin.setName(Config.ORG1_ADMIN);
			...
			org2Admin.setName(Config.ORG2_ADMIN);
			...
			response = channelClient.instantiateChainCode(Config.CHAINCODE_1_NAME, Config.CHAINCODE_1_VERSION,
					Config.CHAINCODE_1_PATH, Type.GO_LANG.toString(), "init", arguments, null, Config.PRIVATEDATA_CONFIG);
