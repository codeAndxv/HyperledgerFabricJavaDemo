...
public class InvokeChaincodePersonInfo {
	...
	public static void main(String args[]) {
		try {
			...
			request.setFcn("writePersonInfoPrivate2");
			String[] arguments = { "pii0000001", "pi0000001", "dti0000001", "1", "20", "0.1", "1", "1535463630", "1535463830", "31.2560647256,121.3974237442" ,"31.2594765066,121.4078521729" };

			request.setFcn("writePersonInfoPublic");
			...
			for (ProposalResponse res: responses) {
				...
				Logger.getLogger(InvokeChaincodePersonInfo.class.getName()).log(Level.INFO,"Invoked writePersonInfoPrivate1 on "+Config.CHAINCODE_1_NAME + ". Status - " + status);
			}
