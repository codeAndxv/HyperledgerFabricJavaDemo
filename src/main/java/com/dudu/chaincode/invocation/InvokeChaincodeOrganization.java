...
public class InvokeChaincodeOrganization {
	...
	public static void main(String args[]) {
		try {
			...
			request.setFcn("writeOrganization");
			String[] arguments = { "org0000001", "org1", "account1", "shanghai", "100" };
			...
			for (ProposalResponse res: responses) {
				...
				Logger.getLogger(InvokeChaincodeOrganization.class.getName()).log(Level.INFO,"Invoked writeOrganization on "+Config.CHAINCODE_1_NAME + ". Status - " + status);
			}
