...
public class ChannelClient {
	...
	public Collection<ProposalResponse> instantiateChainCode(String chaincodeName, String version, String chaincodePath,
															 ...
															 String policyPath,String privateDataConfigfilePath)
			throws InvalidArgumentException, ProposalException, ChaincodeEndorsementPolicyParseException, IOException, ChaincodeCollectionConfigurationException {
		Logger.getLogger(ChannelClient.class.getName()).log(Level.INFO,
		...
		if (privateDataConfigfilePath != null) {
			instantiateProposalRequest.setChaincodeCollectionConfiguration(ChaincodeCollectionConfiguration.fromYamlFile(new File(privateDataConfigfilePath)));
		}
